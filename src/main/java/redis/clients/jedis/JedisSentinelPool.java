    ...
    protected class MasterListener extends Thread {
        ...
        public void run() {
           ...
           */
                    ...
                    if (masterAddr == null || masterAddr.size() != 2) {
                        log.warn("Can not get master addr, master name: " + masterName + ". Sentinel: " + host + "：" + port + ".");
                    } else {
                    ...
                    j.subscribe(new JedisPubSub() {
                        ...
                        public void onMessage(String channel, String message) {
                            log.debug("Sentinel " + host + ":" + port + " published: " + message + ".");
                            ...
                            if (switchMasterMsg.length > 3) {
                                ...
                                log.error(
                                        "Invalid message received on Sentinel " + host + ":" + port + " on channel +switch-master: " + message);
                            }
                        }
                    }, "+switch-master");
                    ...
                    if (running.get()) {
                        log.error("Lost connection to Sentinel at " + host + ":" + port + ". Sleeping 5000ms and retrying.", e);
                        try {
